...
class Cartoonizer:
    ...
    def render(self, img_rgb):
        ...
        # OR simply use below commented block to changes colours and comment this line
        ...
        #
        # # print("******bilateralFilter", img_color.shape)
        #
        ...
        # cv2.imwrite('messigray.png', img_color)
        ...
        cv2.imwrite('messigray2.png', img_edge)
